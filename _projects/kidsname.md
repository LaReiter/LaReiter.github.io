...
For at undersøge formelt, om der er forskel mellem generationer (før 1970, 1970 - 1990, og 1990 og frem) udførte jeg en permuteret variansanalyse (PERMANOVA). Svaret fra hver respondent kan sammenfattes i en 10-dimensional vektor som tager værdier mellem 0 ot 10. For at måle afstanden mellem to respondenter valgte jeg en manhatten afstandsmetrik. Hvis $$x_{ij}$$ og $$x_{ik}$$ er antal tildelte point til spørgsmål $$i$$ for hhv. respondent $$j$$ og respondent $$k$$, så er manhatten afstanden mellem de to respondenter givet ved
