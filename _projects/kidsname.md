...
Svarene fordeler sig bredt indenfor årgangene, men tre klare tendenser går igen på tværs af årgange: **Navnet skal passe til køn** (høj prioritet), **traditioner** (lav prioritet) og **signalværdi** (lav prioritet). Generelt lader det til at de ældre generationer er mere enige om betydningen af de forskellige kriterier. De ældre generationer er fx meget uinteresserede i om andre synes om deres valg af navn, ligesom de ikke prioriterer at navnet skal være unikt. For de nyere generationer, er der mere uenighed om hvorvidt andres mening betyder noget og om hvorvidt navnet skal tilstræbes at være unikt. Kigger vi på spørgsmålet om hvorvidt navnet skal passe til kønnet, er det måske blevet en mindre prioritet for de nye generationer. Dette kan være et udtryk for det moderne kønsbegreb er under forandring. Det hele er dog visuelle observationer, og skal tages med et gran salt. Særlig kan vi bemærke, at der blandt den ældste generation kun er 32 respondenter. 

### Statistisk undersøgelse

For at undersøge formelt, om der er forskel mellem generationer (før 1970, 1970 - 1990, og 1990 og frem) udførte jeg en permuteret variansanalyse (PERMANOVA). Svaret fra hver respondent kan sammenfattes i en 10-dimensional vektor som tager værdier mellem 0 og 10. Afstanden mellem svarene fra to respondenter blev defineret som summen af de absolutte forskelle inden for hvert spørgsmål, også kendt som manhatten afstanden. Hvis $$x_{ij}$$ og $$x_{ik}$$ er antal tildelte point til spørgsmål $$i$$ for hhv. respondent $$j$$ og respondent $$k$$, så er manhatten afstanden mellem de to respondenter givet ved
$$d_{jk} = \sum_{i=1}^{10} |x_{ij} - x_{ik}|$$. Jeg udførte testen i programmet R med pakken **vegan** og fandt en F-værdi på 2.878 og en tilhørende p-værdi på 0.004, hvilket betyder at der er signifikant forskel imellen generationerne på et 5% signifikansniveau. En antagelse bag PERMANOVA er at variationen inden for hver generationsgruppe er på et sammenlignelig niveau generationsgrupperne imellem. Det blev kontrolleret ved at foretage ensidet variansanalyse på forskellene mellem svar-vektorerne og gennemsnittet af svar-vektorerne (centroiden) inden for hver gruppe. Vi fandt ingen signifikant forskel i variation på et 5% signifikansniveau. 

### Blev vi klogere? Hvad med spørgsmål 12?

Spørgeskemaundersøgelsen bekræfter at generationerne har forskellige kriterier når det kommer til navngivning, men præcis hvilke forskelle der driver den ændring i popularitetsfordelingen, som vi så i den øverste figur, forbliver spekulativt. Jeg har dog endnu ikke behandlet Spørgsmål 12, som enten kan tilgås kvalitativt (læse sig igennem de mange svar og fastslå mønstre) eller gennem maskinlæring, som fx. *sentiment analyse*/*opinion mining*. Artiklen vil i så fald blive opdateret.
