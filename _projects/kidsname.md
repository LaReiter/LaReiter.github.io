...
$$d_{jk} = \sum_{i=1}^{10} |x_{ij} - x_{ik}|$$. Jeg udførte testen i programmet R med pakken **vegan** og fandt en F-værdi på 2.878 og en tilhørende p-værdi på 0.004, hvilket betyder at der er signifikant forskel imellen generationerne på et 5% signifikansniveau. En antagelse bag PERMANOVA er at variationen inden for hver generationsgruppe er på et sammenlignelig niveau. Det blev kontrolleret ved at foretage ensidet variansanalyse på forskellene mellem svar-vektorerne og gennemsnittet af svar-vektorerne (centroiden) inden for hver gruppe. Vi fandt ingen signifikant forskel i variation på et 5% signifikansniveau. 
